...
public class PartitionedRepositoryImplPrepareCosmosDocumentRichDataTests
{
    private readonly PartitionedRepositoryImpl<TestData.RichDataEntity> _repository = new(CreateMockDatabaseContext());
    private readonly Guid _tenantId = Guid.NewGuid();

    [Fact]
    public void Should_Add_TenantId_PartitionKey_To_RichDataEntity_Document()
    {
        // Arrange
    ...
    [Fact]
    public void Should_Handle_Different_TenantIds_With_RichData()
    {
        // Arrange
        var entity = TestData.NewRichTestEntity;
        ...
        // All other data should be identical
        ...
        document1[GetJsonPropertyName(nameof(entity.Name))]?.ToString().Should().Be(document2[GetJsonPropertyName(nameof(entity.Name))]?.ToString());
        document1[GetJsonPropertyName(nameof(entity.IntValue))]?.GetValue<int>().Should().Be(document2[GetJsonPropertyName(nameof(entity.IntValue))]?.GetValue<int>());
    }
